...
[`.apm/skills/opentelemetry-tracing-common/SKILL.md`](.apm/skills/opentelemetry-tracing-common/SKILL.md)
...
- **Cross-cutting gates:** multi-language scope (common `SKILL.md`), L3
...
- **Reference:** `reference/` — platform contract (`platform-tracing-guide.md` via common)
...
- L4 apply (framework gate, recipes) and L5 runtime execution (fresh-build,
  validation-stack, deploy); stand health, log triage, and cleanup use common
  `recipes/`
