...
APM skill for **Python** services (FastAPI/ASGI, Django and Flask/WSGI, pure OTel SDK):
...
[`SKILL.md`](.apm/skills/opentelemetry-tracing-python/SKILL.md). Each layer reads
...
[`SKILL.md`](.apm/skills/opentelemetry-tracing-python/SKILL.md) §6, the copy the agent reads and the only place they
are listed. Shared core: [`../opentelemetry-tracing-common/`](../opentelemetry-tracing-common/).
