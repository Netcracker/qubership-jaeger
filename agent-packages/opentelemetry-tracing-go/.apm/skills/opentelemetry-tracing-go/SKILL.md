...
This skill is an analysis pipeline. It takes an unknown Go repository as input
...
- enabling or auditing distributed tracing in Go services;
...
- fixing context propagation loss across HTTP/Kafka/goroutines;
- work touching `TRACING_*`, OTLP, sampling, propagators, or trace-log correlation.

Do not use for Java/Python/JS services.
